        ...
        <div class="auth-box p-4 bg-white rounded">
          <div>
            <div class="logo text-center">
              <span class="db"><img src="https://mobsign.com/wp-content/uploads/2022/07/logo-mobsign-200x47.png" alt="logo"/></span>
              <h5 class="font-weight-medium mb-3 mt-1">Recuperar Contraseña</h5>
            </div>
            <!-- Form -->
            <div class="row">
              <div class="col-12">
                <form class="form-horizontal mt-3" action="index.html">
                  <div class="mb-3 row">
                    <div class="col-12">
                      <input class="form-control" type="text" required="" placeholder="Contraseña"/>
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <div class="col-12">
                      <input class="form-control" type="text" required="" placeholder="Confirme Contraseña"/>
                    </div>
                  </div>
