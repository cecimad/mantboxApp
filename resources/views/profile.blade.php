            ...
            <div class="col-lg-12 col-xlg-3 col-md-5">
              <div class="card">
                <div class="card-body">
                  <center class="mt-4">
                    <img
                      src="../package/assets/images/users/5.jpg"
                      class="rounded-circle"
                      width="150"
                    />
                    <h4 class="card-title mt-2">{{ $data['data']['usuarios']['name'] }}</h4>
                    <h6 class="card-subtitle">{{ $data['message'] }}</h6>
                    <div class="row text-center justify-content-md-center">
                      ...
                      <div class="col-4">
                        <a href="javascript:void(0)" class="link"
                          ><i class="ri-image-line fs-3 align-middle"></i>
                ...
                <div class="card-body">
                  ...
                  <h6>{{ $data['data']['usuarios']['email'] }}</h6>
                  ...
                  <div class="map-box">
                  <iframe
                      src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d27891.16236272322!2d-110.9698414167618!3d29.094009036187128!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2s!5e0!3m2!1ses-419!2smx!4v1718140928012!5m2!1ses-419!2smx"
                      width="100%"
                      height="150"
                      frameborder="0"
                      style="border: 0"
                        ...
                        <div class="sl-item d-flex align-items-start">
                          ...
                          <div class="sl-right">
                            <div>
                              ...
                              <div class="like-comm mt-3 d-flex">
                                ...
                                <a
                                  ...
                                  ><i
                                    class="ri-heart-fill text-danger fs-4 me-1"
                                  ></i>
                                  5 Love</a
                                >
                              </div>
